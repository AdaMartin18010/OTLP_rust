...
- [Rust 1.90 可观测性与可靠性知识图谱 2025年10月](#rust-190-可观测性与可靠性知识图谱-2025年10月)
  - [📋 目录](#-目录)
  - [🌐 知识图谱总览](#-知识图谱总览)
    - [1.1 顶层架构图](#11-顶层架构图)
    - [1.2 概念关系网络](#12-概念关系网络)
  - [🔗 核心概念关系图](#-核心概念关系图)
    - [2.1 可观测性三支柱关系](#21-可观测性三支柱关系)
    - [2.2 可靠性模式依赖关系](#22-可靠性模式依赖关系)
  - [📊 多维度矩阵对比](#-多维度矩阵对比)
    - [3.1 技术栈对比矩阵](#31-技术栈对比矩阵)
    - [3.2 可靠性模式对比矩阵](#32-可靠性模式对比矩阵)
    - [3.3 异步运行时对比矩阵](#33-异步运行时对比矩阵)
  - [💎 属性特性分析](#-属性特性分析)
    - [4.1 Rust 1.90核心特性属性表](#41-rust-190核心特性属性表)
    - [4.2 OpenTelemetry 0.31属性矩阵](#42-opentelemetry-031属性矩阵)
  - [🔧 技术栈依赖图](#-技术栈依赖图)
    - [5.1 完整技术栈依赖关系](#51-完整技术栈依赖关系)
    - [5.2 依赖权重分析](#52-依赖权重分析)
  - [📈 演进路径图](#-演进路径图)
    - [6.1 Rust生态系统演进时间线](#61-rust生态系统演进时间线)
    - [6.2 产业采用成熟度曲线](#62-产业采用成熟度曲线)
  - [💡 实践应用映射](#-实践应用映射)
    - [7.1 场景到技术栈映射表](#71-场景到技术栈映射表)
    - [7.2 产业应用技术栈解构](#72-产业应用技术栈解构)
      - [字节跳动推荐系统](#字节跳动推荐系统)
      - [华为鸿蒙OS内核](#华为鸿蒙os内核)
  - [⚡ 性能维度分析](#-性能维度分析)
    - [8.1 性能金字塔模型](#81-性能金字塔模型)
    - [8.2 性能-可靠性权衡矩阵](#82-性能-可靠性权衡矩阵)
    - [8.3 延迟分布热力图](#83-延迟分布热力图)
  - [📖 知识图谱应用指南](#-知识图谱应用指南)
    - [9.1 按角色导航](#91-按角色导航)
      - [架构师视角](#架构师视角)
      - [开发者视角](#开发者视角)
      - [SRE视角](#sre视角)
    - [9.2 学习路径推荐](#92-学习路径推荐)
  - [🔍 交互式查询指南](#-交互式查询指南)
    - [10.1 常见问题映射](#101-常见问题映射)
    - [10.2 决策树](#102-决策树)
  - [附录](#附录)
    - [A. 术语对照表](#a-术语对照表)
    - [B. 参考资源](#b-参考资源)
