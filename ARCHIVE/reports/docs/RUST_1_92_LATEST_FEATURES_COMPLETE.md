...
- [Rust 1.92.0 最新特性完整说明](#rust-1920-最新特性完整说明)
  - [📋 目录](#-目录)
  - [1. Rust 1.92.0 核心特性](#1-rust-1920-核心特性)
    - [1.1 `!`（never）类型的稳定化 ⚠️ 重要变更](#11-never类型的稳定化-️-重要变更)
    - [1.2 异步编程改进 ✨ 新特性](#12-异步编程改进--新特性)
    - [1.3 标准库和工具链增强 🔧 改进](#13-标准库和工具链增强--改进)
      - [元组的 `FromIterator` 和 `Extend` 实现](#元组的-fromiterator-和-extend-实现)
      - [`std::env::home_dir()` 的更新](#stdenvhome_dir-的更新)
      - [Cargo 的工作区发布支持](#cargo-的工作区发布支持)
    - [1.4 平台支持提升 🚀 新特性](#14-平台支持提升--新特性)
    - [1.5 其他重要改进 🔍 改进](#15-其他重要改进--改进)
      - [属性检查的加强](#属性检查的加强)
      - [展开表的默认启用](#展开表的默认启用)
  - [2. 项目对齐情况](#2-项目对齐情况)
    ...
    - [2.2 特性对齐验证](#22-特性对齐验证)
      - [`!` 类型 lint 升级](#-类型-lint-升级)
      - [异步编程改进](#异步编程改进)
      - [标准库和工具链增强](#标准库和工具链增强)
      - [平台支持提升](#平台支持提升)
      - [其他改进](#其他改进)
  - [3. 特性应用建议](#3-特性应用建议)
    ...
    - [3.2 异步编程改进应用](#32-异步编程改进应用)
    - [3.3 标准库和工具链增强应用](#33-标准库和工具链增强应用)
  - [4. 迁移指南](#4-迁移指南)
    - [4.1 从 Rust 1.91 迁移到 Rust 1.92](#41-从-rust-191-迁移到-rust-192)
      - [1. 更新 Rust 工具链](#1-更新-rust-工具链)
      - [2. 检查并修复 `!` 类型相关的 lint 警告](#2-检查并修复--类型相关的-lint-警告)
      - [3. 更新项目配置](#3-更新项目配置)
      - [4. 利用新特性](#4-利用新特性)
    - [4.2 常见问题](#42-常见问题)
      - [Q1: 编译错误：`!` 类型相关的 lint 错误](#q1-编译错误-类型相关的-lint-错误)
      - [Q2: 如何使用异步闭包？](#q2-如何使用异步闭包)
      - [Q3: Cargo 工作区发布如何使用？](#q3-cargo-工作区发布如何使用)
  - [5. 总结](#5-总结)
    - [5.1 主要改进](#51-主要改进)
    - [5.2 项目状态](#52-项目状态)
