...
- [快速入门核心概念](#快速入门核心概念)
  - [📋 目录](#-目录)
  - [📖 OTLP基础概念](#-otlp基础概念)
    - [1.1 什么是OTLP](#11-什么是otlp)
      - [定义](#定义)
      - [核心组件](#核心组件)
      - [关键术语](#关键术语)
  - [🔍 第一个追踪应用](#-第一个追踪应用)
    - [2.1 5分钟快速开始](#21-5分钟快速开始)
      - [步骤1: 创建项目](#步骤1-创建项目)
      - [步骤2: 最简单的示例](#步骤2-最简单的示例)
    - [2.2 带导出功能的完整示例](#22-带导出功能的完整示例)
      - [步骤1: 启动OTLP Collector (Docker)](#步骤1-启动otlp-collector-docker)
      - [步骤2: 更新代码添加导出](#步骤2-更新代码添加导出)
    - [2.3 使用tracing宏（推荐方式）](#23-使用tracing宏推荐方式)
      - [更简洁的写法](#更简洁的写法)
  - [💡 基本配置](#-基本配置)
  ...
  - [⚙️ 常见问题](#️-常见问题)
    - [4.1 为什么看不到数据？](#41-为什么看不到数据)
      - [检查清单](#检查清单)
      - [调试技巧](#调试技巧)
    - [4.2 性能影响](#42-性能影响)
      - [典型开销](#典型开销)
    - [4.3 常见错误](#43-常见错误)
      - [错误1: "connection refused"](#错误1-connection-refused)
      - [错误2: "spans dropped"](#错误2-spans-dropped)
      - [错误3: "no data in backend"](#错误3-no-data-in-backend)
    - [4.4 最佳实践](#44-最佳实践)
      - [DO ✅](#do-)
      - [DON'T ❌](#dont-)
  - [📊 下一步](#-下一步)
