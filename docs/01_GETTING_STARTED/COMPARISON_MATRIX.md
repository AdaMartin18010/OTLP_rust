...
- [快速入门对比矩阵](#快速入门对比矩阵)
  - [📋 目录](#-目录)
  - [⚖️ 追踪方式对比](#️-追踪方式对比)
    - [1.1 手动 vs 自动追踪](#11-手动-vs-自动追踪)
    - [1.2 代码示例对比](#12-代码示例对比)
  - [🔗 导出器选择对比](#-导出器选择对比)
    - [2.1 导出器类型](#21-导出器类型)
    - [2.2 新手推荐流程](#22-新手推荐流程)
    - [2.3 代码示例对比](#23-代码示例对比)
  - [⚡ 学习曲线对比](#-学习曲线对比)
    - [3.1 学习路径对比](#31-学习路径对比)
    - [3.2 路径详情](#32-路径详情)
      - [快速路径 (1天)](#快速路径-1天)
      - [标准路径 (1周)](#标准路径-1周)
      - [深入路径 (2-4周)](#深入路径-2-4周)
  - [🎯 开发环境对比](#-开发环境对比)
    - [4.1 环境选择](#41-环境选择)
    - [4.2 环境搭建对比](#42-环境搭建对比)
      - [本地开发 (推荐新手)](#本地开发-推荐新手)
      - [Docker环境 (推荐团队)](#docker环境-推荐团队)
      - [Docker Compose (最佳实践)](#docker-compose-最佳实践)
  - [📚 Web框架集成对比](#-web框架集成对比)
    - [5.1 主流框架对比](#51-主流框架对比)
    - [5.2 集成代码对比](#52-集成代码对比)
  - [📊 常见选择场景](#-常见选择场景)
    - [6.1 场景决策表](#61-场景决策表)
    - [6.2 快速决策流程图](#62-快速决策流程图)
  - [💡 成本对比](#-成本对比)
    - [7.1 搭建和运行成本](#71-搭建和运行成本)
    - [7.2 学习投入对比](#72-学习投入对比)
  - [✅ 性能影响对比](#-性能影响对比)
    - [8.1 不同配置的性能影响](#81-不同配置的性能影响)
  - [📚 推荐组合](#-推荐组合)
    - [9.1 新手推荐](#91-新手推荐)
    - [9.2 团队推荐](#92-团队推荐)
  - [🔗 相关资源](#-相关资源)
