...
- [参考文档对比矩阵](#参考文档对比矩阵)
  - [📋 目录](#-目录)
  - [⚖️ 协议对比](#️-协议对比)
    - [1.1 OTLP协议版本](#11-otlp协议版本)
    - [1.2 传输协议性能对比](#12-传输协议性能对比)
    - [1.3 协议特性对比](#13-协议特性对比)
  - [🔗 SDK实现对比](#-sdk实现对比)
    - [2.1 语言SDK对比](#21-语言sdk对比)
    - [2.2 Rust SDK性能基准](#22-rust-sdk性能基准)
    - [2.3 SDK特性对比](#23-sdk特性对比)
  - [⚡ 导出器对比](#-导出器对比)
    - [3.1 Exporter实现对比](#31-exporter实现对比)
    - [3.2 导出器性能对比](#32-导出器性能对比)
    - [3.3 批处理配置对比](#33-批处理配置对比)
  - [🎯 语义约定版本对比](#-语义约定版本对比)
    - [4.1 语义约定演进](#41-语义约定演进)
    - [4.2 主要变更](#42-主要变更)
    - [4.3 语义约定覆盖对比](#43-语义约定覆盖对比)
  - [📚 采样策略对比](#-采样策略对比)
    - [5.1 采样器类型](#51-采样器类型)
    - [5.2 采样决策对比](#52-采样决策对比)
  - [📊 Context传播对比](#-context传播对比)
    - [6.1 传播格式](#61-传播格式)
    - [6.2 传播开销](#62-传播开销)
  - [💡 后端存储对比](#-后端存储对比)
    - [7.1 Trace后端对比](#71-trace后端对比)
    - [7.2 成本对比](#72-成本对比)
  - [✅ 决策建议](#-决策建议)
