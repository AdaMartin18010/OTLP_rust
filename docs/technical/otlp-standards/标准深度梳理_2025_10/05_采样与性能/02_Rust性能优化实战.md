...
- [Rust OTLP 性能优化实战](#rust-otlp-性能优化实战)
  - [目录](#目录)
  - [1. Rust 零成本抽象优势](#1-rust-零成本抽象优势)
    - [1.1 编译时 Span 优化](#11-编译时-span-优化)
    - [1.2 类型状态模式优化](#12-类型状态模式优化)
  - [2. 编译时优化](#2-编译时优化)
    - [2.1 Cargo 优化配置](#21-cargo-优化配置)
    - [2.2 特性门控](#22-特性门控)
  - [3. 异步性能优化](#3-异步性能优化)
    - [3.1 零拷贝异步导出](#31-零拷贝异步导出)
    - [3.2 Tokio 运行时优化](#32-tokio-运行时优化)
  - [4. 内存优化](#4-内存优化)
    - [4.1 对象池](#41-对象池)
    - [4.2 零拷贝序列化](#42-零拷贝序列化)
  - [5. 批处理优化](#5-批处理优化)
    - [5.1 智能批处理器](#51-智能批处理器)
  - [6. 采样策略](#6-采样策略)
    - [6.1 自适应采样](#61-自适应采样)
  - [7. 性能基准测试](#7-性能基准测试)
