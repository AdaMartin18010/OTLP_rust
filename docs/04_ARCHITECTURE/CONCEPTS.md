...
- [架构设计核心概念](#架构设计核心概念)
  - [📋 目录](#-目录)
  - [📖 微服务架构概念](#-微服务架构概念)
    - [1.1 服务边界 (Service Boundary)](#11-服务边界-service-boundary)
      - [定义](#定义)
      - [内涵（本质特征）](#内涵本质特征)
      - [外延（涵盖范围）](#外延涵盖范围)
      - [属性](#属性)
      - [关系](#关系)
      - [示例](#示例)
    - [1.2 API网关 (API Gateway)](#12-api网关-api-gateway)
      - [定义](#定义-1)
      - [内涵（本质特征）](#内涵本质特征-1)
      - [外延（涵盖范围）](#外延涵盖范围-1)
      - [属性](#属性-1)
      ...
      - [示例](#示例-1)
  - [🔍 分布式系统概念](#-分布式系统概念)
    - [2.1 CAP定理 (CAP Theorem)](#21-cap定理-cap-theorem)
      - [定义](#定义-2)
      - [内涵（本质特征）](#内涵本质特征-2)
      - [外延（涵盖范围）](#外延涵盖范围-2)
      - [属性](#属性-2)
      ...
      - [示例](#示例-2)
  - [💡 可扩展性概念](#-可扩展性概念)
    - [3.1 水平扩展 (Horizontal Scaling)](#31-水平扩展-horizontal-scaling)
      - [定义](#定义-3)
      - [内涵（本质特征）](#内涵本质特征-3)
      - [外延（涵盖范围）](#外延涵盖范围-3)
      - [属性](#属性-3)
      ...
      - [示例](#示例-3)
  - [⚙️ 可观测性概念](#️-可观测性概念)
    - [4.1 三大支柱 (Three Pillars)](#41-三大支柱-three-pillars)
      - [定义](#定义-4)
      - [内涵（本质特征）](#内涵本质特征-4)
      - [外延（涵盖范围）](#外延涵盖范围-4)
      - [属性](#属性-4)
      ...
      - [示例](#示例-4)
  - [📊 服务网格概念](#-服务网格概念)
    - [5.1 Sidecar模式 (Sidecar Pattern)](#51-sidecar模式-sidecar-pattern)
      - [定义](#定义-5)
      - [内涵（本质特征）](#内涵本质特征-5)
      - [外延（涵盖范围）](#外延涵盖范围-5)
      - [属性](#属性-5)
