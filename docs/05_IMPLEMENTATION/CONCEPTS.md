...
- [实施核心概念](#实施核心概念)
  - [📋 目录](#-目录)
  - [📖 批处理器实现](#-批处理器实现)
    - [1.1 BatchSpanProcessor (批量Span处理器)](#11-batchspanprocessor-批量span处理器)
      - [定义](#定义)
      - [内涵（本质特征）](#内涵本质特征)
      - [外延（涵盖范围）](#外延涵盖范围)
      - [属性](#属性)
      ...
      - [示例](#示例)
  - [🔍 导出器模式](#-导出器模式)
    - [2.1 SpanExporter (Span导出器)](#21-spanexporter-span导出器)
      - [定义](#定义-1)
      - [内涵（本质特征）](#内涵本质特征-1)
      - [外延（涵盖范围）](#外延涵盖范围-1)
      - [属性](#属性-1)
  ...
  - [💡 异步运行时](#-异步运行时)
    - [3.1 Tokio运行时配置](#31-tokio运行时配置)
      ...
      - [示例](#示例-2)
  - [⚙️ 内存管理](#️-内存管理)
    - [4.1 对象池 (Object Pool)](#41-对象池-object-pool)
      - [定义](#定义-3)
      - [内涵（本质特征）](#内涵本质特征-3)
      - [外延（涵盖范围）](#外延涵盖范围-3)
      - [属性](#属性-3)
