...
- [API核心概念](#api核心概念)
  ...
  - [📖 OTLP协议概念](#-otlp协议概念)
    - [1.1 Span (跨度)](#11-span-跨度)
      ...
      - [关系](#关系)
      - [示例](#示例)
    - [1.2 Resource (资源)](#12-resource-资源)
      - [定义](#定义-1)
      - [内涵（本质特征）](#内涵本质特征-1)
      - [外延（涵盖范围）](#外延涵盖范围-1)
      - [属性](#属性-1)
      ...
      - [示例](#示例-1)
  - [🔍 数据模型概念](#-数据模型概念)
    - [2.1 批处理 (Batching)](#21-批处理-batching)
      - [定义](#定义-2)
      - [内涵（本质特征）](#内涵本质特征-2)
      - [外延（涵盖范围）](#外延涵盖范围-2)
      - [属性](#属性-2)
      ...
      - [示例](#示例-2)
  - [💡 传输机制概念](#-传输机制概念)
    - [3.1 gRPC流式传输 (gRPC Streaming)](#31-grpc流式传输-grpc-streaming)
      - [定义](#定义-3)
      - [内涵（本质特征）](#内涵本质特征-3)
      - [外延（涵盖范围）](#外延涵盖范围-3)
      - [属性](#属性-3)
      ...
      - [示例](#示例-3)
  - [⚙️ 性能优化概念](#️-性能优化概念)
    - [4.1 Zero-Copy (零拷贝)](#41-zero-copy-零拷贝)
      - [定义](#定义-4)
      - [内涵（本质特征）](#内涵本质特征-4)
      - [外延（涵盖范围）](#外延涵盖范围-4)
      - [属性](#属性-4)
