...
- [HTTP 追踪最佳实践 - HTTP Tracing Best Practices](#http-追踪最佳实践---http-tracing-best-practices)
  - [📋 目录](#-目录)
  - [概述](#概述)
  - [W3C Trace Context](#w3c-trace-context)
    ...
    - [Axum集成示例](#axum集成示例)
  - [HTTP语义约定](#http语义约定)
    - [OpenTelemetry HTTP Semantic Conventions](#opentelemetry-http-semantic-conventions)
    - [完整的HTTP Span示例](#完整的http-span示例)
  - [自动化追踪](#自动化追踪)
    - [Axum自动追踪](#axum自动追踪)
    - [Actix-web自动追踪](#actix-web自动追踪)
  - [手动追踪](#手动追踪)
    - [细粒度控制](#细粒度控制)
    - [创建子Span](#创建子span)
  - [上下文传播](#上下文传播)
