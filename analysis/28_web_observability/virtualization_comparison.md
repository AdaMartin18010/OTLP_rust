...
- [虚拟化技术对比 - Docker vs Wasm vs VM](#虚拟化技术对比---docker-vs-wasm-vs-vm)
  - [📋 目录](#-目录)
  - [概述](#概述)
    - [三大虚拟化技术](#三大虚拟化技术)
  - [技术对比](#技术对比)
    - [🆕 2025年最新基准数据](#-2025年最新基准数据)
    - [1. 核心特性对比](#1-核心特性对比)
    - [2. 架构对比](#2-架构对比)
    - [3. 详细技术参数](#3-详细技术参数)
      - [虚拟机 (VM)](#虚拟机-vm)
  ...
  - [可观测性对比](#可观测性对比)
    - [1. 追踪能力对比](#1-追踪能力对比)
    - [2. OTLP 集成复杂度](#2-otlp-集成复杂度)
    - [3. 监控指标对比](#3-监控指标对比)
  - [场景选择](#场景选择)
    - [决策树](#决策树)
    - [场景推荐](#场景推荐)
      - [场景 1: 企业Web应用](#场景-1-企业web应用)
      - [场景 2: 高安全性要求](#场景-2-高安全性要求)
      - [场景 3: 边缘计算/IoT](#场景-3-边缘计算iot)
      - [场景 4: Serverless平台](#场景-4-serverless平台)
  - [混合部署](#混合部署)
    - [1. Docker + Wasm 混合](#1-docker--wasm-混合)
    - [2. VM + 容器混合](#2-vm--容器混合)
    - [3. 分层架构](#3-分层架构)
  - [最佳实践](#最佳实践)
    - [1. 选择指南](#1-选择指南)
