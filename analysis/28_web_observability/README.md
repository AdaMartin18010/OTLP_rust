...
- [Web 可观测性 - Web Observability](#web-可观测性---web-observability)
  - [📋 目录](#-目录)
  - [概述](#概述)
    - [适用场景](#适用场景)
    - [技术栈覆盖](#技术栈覆盖)
  - [🆕 最新更新 (2025年10月29日)](#-最新更新-2025年10月29日)
  - [文档结构](#文档结构)
  - [核心主题](#核心主题)
    - [1. Web框架集成 🎯](#1-web框架集成-)
    - [2. HTTP追踪最佳实践 📊](#2-http追踪最佳实践-)
    - [3. REST API可观测性 🔍](#3-rest-api可观测性-)
    - [4. GraphQL监控 📈](#4-graphql监控-)
    - [5. WebSocket追踪 🔌](#5-websocket追踪-)
    - [6. Web性能优化 ⚡](#6-web性能优化-)
    - [7. 生产环境部署 🚀](#7-生产环境部署-)
    - [8. OTLP部署架构 ⭐ (新增!)](#8-otlp部署架构--新增)
    - [8. Docker容器可观测性 🐳 🆕](#8-docker容器可观测性--)
    - [9. WasmEdge与WebAssembly可观测性 🚀 🆕](#9-wasmedge与webassembly可观测性--)
    - [10. 虚拟化技术对比 📊 🆕](#10-虚拟化技术对比--)
  - [快速导航](#快速导航)
    - [按角色导航](#按角色导航)
    - [按场景导航](#按场景导航)
  - [学习路径](#学习路径)
  ...
  - [相关资源](#相关资源)
    ...
    - [外部资源](#外部资源)
      ...
      - [社区资源](#社区资源)
  - [实战案例](#实战案例)
    - [案例1: 电商API服务](#案例1-电商api服务)
    - [案例2: 实时聊天服务](#案例2-实时聊天服务)
    - [案例3: GraphQL网关](#案例3-graphql网关)
  - [贡献指南](#贡献指南)
    - [文档贡献](#文档贡献)
    - [代码贡献](#代码贡献)
    - [问题反馈](#问题反馈)
