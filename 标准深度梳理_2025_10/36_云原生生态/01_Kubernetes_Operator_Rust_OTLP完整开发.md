...
- [Kubernetes Operator - Rust + OTLP 完整开发指南](#kubernetes-operator---rust--otlp-完整开发指南)
  - [📋 目录](#-目录)
  - [概述](#概述)
    ...
    - [OTLP 集成价值](#otlp-集成价值)
  - [核心概念](#核心概念)
    - [1. Operator 架构](#1-operator-架构)
    - [2. OTLP 追踪上下文](#2-otlp-追踪上下文)
  - [Rust 1.90 实现](#rust-190-实现)
    - [1. 项目设置](#1-项目设置)
    - [2. 定义 CRD](#2-定义-crd)
    - [3. Reconcile 逻辑](#3-reconcile-逻辑)
    - [4. 资源创建](#4-资源创建)
  - [OTLP 集成策略](#otlp-集成策略)
    - [1. 初始化 OTLP](#1-初始化-otlp)
    - [2. 主函数](#2-主函数)
  - [CRD 设计](#crd-设计)
    - [1. CRD YAML](#1-crd-yaml)
    - [2. 示例 CR](#2-示例-cr)
  - [控制器逻辑](#控制器逻辑)
    - [1. Finalizer 处理](#1-finalizer-处理)
  - [生产部署](#生产部署)
