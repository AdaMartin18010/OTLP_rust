...
- [Arrow DataFusion 查询优化实战 - OTLP 数据分析加速](#arrow-datafusion-查询优化实战---otlp-数据分析加速)
  - [📋 目录](#-目录)
  - [1. DataFusion 简介](#1-datafusion-简介)
    - [1.1 什么是 DataFusion](#11-什么是-datafusion)
    - [1.2 核心特性](#12-核心特性)
  - [2. OTLP 数据查询场景](#2-otlp-数据查询场景)
    - [2.1 典型查询场景](#21-典型查询场景)
  - [3. 查询优化技术](#3-查询优化技术)
    - [3.1 谓词下推优化](#31-谓词下推优化)
    - [3.2 投影下推优化](#32-投影下推优化)
    - [3.3 分区剪枝](#33-分区剪枝)
    - [3.4 向量化执行](#34-向量化执行)
  - [4. 实战案例](#4-实战案例)
    - [4.1 完整的 OTLP 查询引擎](#41-完整的-otlp-查询引擎)
    - [4.2 实时聚合引擎](#42-实时聚合引擎)
  - [5. 性能调优](#5-性能调优)
    - [5.1 查询性能分析](#51-查询性能分析)
    - [5.2 配置优化建议](#52-配置优化建议)
  - [6. 生产部署](#6-生产部署)
    - [6.1 Kubernetes 部署](#61-kubernetes-部署)
    - [6.2 监控指标](#62-监控指标)
  - [总结](#总结)
    - [🎯 DataFusion 最佳实践](#-datafusion-最佳实践)
