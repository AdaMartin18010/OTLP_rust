...
// Rust 1.94 新特性模块
pub mod rust_1_94_features; // Rust 1.94 新特性实现 - 数学建模与算法
...
pub use rust_1_94_features::{
    // 数学常量
    GOLDEN_RATIO, MATH_MODEL_CACHE, MATH_CONSTANTS, MathConstants,
    // 数值模式检测
    NumericalPattern, PatternType, detect_numerical_patterns,
    // 矩阵操作
    CompactMatrix,
    // 优化算法
    golden_section_search, golden_section_search_multid,
    // 欧拉-马歇罗尼常数应用
    harmonic_approximation, harmonic_exact, euler_gamma_approximation_analysis,
    // 多项式求值
    const_polynomial_eval, Polynomial,
    // 统计分析
    StatisticalAnalyzer,
};
