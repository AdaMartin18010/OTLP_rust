...
- [CSP Model API 完整文档](#csp-model-api-完整文档)
  - [📋 目录](#-目录)
  - [概述](#概述)
    - [功能定位](#功能定位)
    - [核心特性](#核心特性)
  - [核心类型系统](#核心类型系统)
    - [1. Channel 通道](#1-channel-通道)
      - [Bounded Channel (有界通道)](#bounded-channel-有界通道)
      - [Unbounded Channel (无界通道)](#unbounded-channel-无界通道)
      - [Oneshot Channel (一次性通道)](#oneshot-channel-一次性通道)
    - [2. Select 选择器](#2-select-选择器)
      - [定义](#定义)
      - [基本用法](#基本用法)
      - [带超时的 Select](#带超时的-select)
      - [多路复用](#多路复用)
    - [3. Broadcast Channel (广播通道)](#3-broadcast-channel-广播通道)
      - [定义](#定义-1)
      - [使用示例](#使用示例)
    - [4. Watch Channel (监视通道)](#4-watch-channel-监视通道)
      - [定义](#定义-2)
      - [使用示例](#使用示例-1)
  - [CSP 模式详解](#csp-模式详解)
    - [1. Pipeline (流水线)](#1-pipeline-流水线)
      - [模式描述](#模式描述)
      - [实现](#实现)
    - [2. Fan-Out (扇出)](#2-fan-out-扇出)
      - [模式描述](#模式描述-1)
      - [实现](#实现-1)
      - [Round-Robin 分发](#round-robin-分发)
    - [3. Fan-In (扇入)](#3-fan-in-扇入)
      - [模式描述](#模式描述-2)
      - [实现](#实现-2)
      - [Merge 函数](#merge-函数)
    - [4. Worker Pool (工作池)](#4-worker-pool-工作池)
      - [实现](#实现-3)
    - [5. Pub-Sub (发布-订阅)](#5-pub-sub-发布-订阅)
      - [实现](#实现-4)
    - [6. Request-Reply (请求-响应)](#6-request-reply-请求-响应)
      - [实现](#实现-5)
    - [7. Priority Channel (优先级通道)](#7-priority-channel-优先级通道)
      - [实现](#实现-6)
  - [并发原语](#并发原语)
  ...
  - [使用示例](#使用示例-2)
    - [示例 1: 数据处理流水线](#示例-1-数据处理流水线)
    - [示例 2: 并发下载器](#示例-2-并发下载器)
    - [示例 3: 事件总线](#示例-3-事件总线)
  - [性能优化](#性能优化)
