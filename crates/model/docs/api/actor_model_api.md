...
- [Actor Model API 完整文档](#actor-model-api-完整文档)
  - [📋 目录](#-目录)
  - [概述](#概述)
    - [功能定位](#功能定位)
    - [核心特性](#核心特性)
  - [核心类型系统](#核心类型系统)
    - [1. Actor Trait](#1-actor-trait)
      - [定义](#定义)
      - [实现示例](#实现示例)
    - [2. ActorRef (Actor 引用)](#2-actorref-actor-引用)
      - [定义](#定义-1)
      - [使用示例](#使用示例)
    - [3. ActorContext (Actor 上下文)](#3-actorcontext-actor-上下文)
      - [定义](#定义-2)
      - [使用示例](#使用示例-1)
    - [4. ActorSystem (Actor 系统)](#4-actorsystem-actor-系统)
      - [定义](#定义-3)
      - [使用示例](#使用示例-2)
  ...
  - [消息传递机制](#消息传递机制)
    ...
    - [发送模式](#发送模式)
      ...
      - [3. Ask Pattern（简化版）](#3-ask-pattern简化版)
  ...
  - [监督策略](#监督策略)
    - [SupervisionStrategy](#supervisionstrategy)
      ...
      - [实现监督者](#实现监督者)
  - [使用示例](#使用示例-3)
    - [示例 1: 计数器系统](#示例-1-计数器系统)
    - [示例 2: Worker Pool](#示例-2-worker-pool)
    - [示例 3: 聊天室系统](#示例-3-聊天室系统)
  - [性能优化](#性能优化)
    - [1. 消息批处理](#1-消息批处理)
    - [2. 消息优先级](#2-消息优先级)
    - [3. 零拷贝消息传递](#3-零拷贝消息传递)
  - [最佳实践](#最佳实践)
    - [1. Actor 设计原则](#1-actor-设计原则)
    - [2. 消息不可变性](#2-消息不可变性)
    - [3. 错误处理](#3-错误处理)
  - [总结](#总结)
