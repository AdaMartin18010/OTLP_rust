...
- [Model Crate 知识图谱](#model-crate-知识图谱)
  - [📋 目录](#-目录)
  - [📖 并发模型全景](#-并发模型全景)
    - [1.1 并发模型架构](#11-并发模型架构)
    - [1.2 并发模型对比](#12-并发模型对比)
  - [📝 状态管理体系](#-状态管理体系)
    - [2.1 状态机完整模型](#21-状态机完整模型)
    - [2.2 版本化状态管理](#22-版本化状态管理)
  - [🔍 速率限制模型](#-速率限制模型)
    - [3.1 四种速率限制算法对比](#31-四种速率限制算法对比)
    - [3.2 速率限制性能对比](#32-速率限制性能对比)
  - [🔧 背压控制机制](#-背压控制机制)
    - [4.1 背压策略完整架构](#41-背压策略完整架构)
    - [4.2 背压流程序列图](#42-背压流程序列图)
  - [📊 形式化建模](#-形式化建模)
    - [5.1 TLA+规约示例](#51-tla规约示例)
    - [5.2 Loom并发测试](#52-loom并发测试)
  - [🌟 概念关系矩阵](#-概念关系矩阵)
    - [6.1 核心组件依赖关系](#61-核心组件依赖关系)
    - [6.2 并发模型特征矩阵](#62-并发模型特征矩阵)
  - [🔬 性能特征分析](#-性能特征分析)
    - [7.1 并发模型性能对比](#71-并发模型性能对比)
    - [7.2 速率限制算法性能](#72-速率限制算法性能)
  - [🔗 相关资源](#-相关资源)
