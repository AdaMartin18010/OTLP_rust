# 🛡️ reliability - Rust统一可靠性框架

## 📋 目录

- [🛡️ reliability - Rust统一可靠性框架](#️-reliability---rust统一可靠性框架)
  - [📋 目录](#-目录)
...
```rust
use reliability::fault_tolerance::{CircuitBreaker, CircuitBreakerConfig};
...
```rust
use reliability::fault_tolerance::rate_limiting::{
...
```rust
use reliability::observability::metrics_aggregation::MetricsAggregator;
use std::time::Duration;
...
```rust
use reliability::design_patterns::observer::{EventBus, Event};
...
- 问题反馈：[GitHub Issues](https://github.com/yourusername/reliability/issues)
- 功能请求：[GitHub Discussions](https://github.com/yourusername/reliability/discussions)
