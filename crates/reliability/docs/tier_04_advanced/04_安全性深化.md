...
- [04 安全性深化](#04-安全性深化)
  ...
  - [📝 内存安全](#-内存安全)
    - [2.1 Use-After-Free (UAF)](#21-use-after-free-uaf)
      - [2.1.1 Rust Safe 代码中的 UAF 防护](#211-rust-safe-代码中的-uaf-防护)
      - [2.1.2 Unsafe 代码中的 UAF 风险](#212-unsafe-代码中的-uaf-风险)
      - [2.1.3 UAF 检测工具](#213-uaf-检测工具)
    - [2.2 缓冲区溢出](#22-缓冲区溢出)
      - [2.2.1 Rust 自动防护](#221-rust-自动防护)
      - [2.2.2 Unsafe 索引的风险](#222-unsafe-索引的风险)
      - [2.2.3 FFI 缓冲区溢出](#223-ffi-缓冲区溢出)
    - [2.3 Unsafe Rust 最佳实践](#23-unsafe-rust-最佳实践)
      - [2.3.1 最小化 Unsafe 范围](#231-最小化-unsafe-范围)
      - [2.3.2 编写 SAFETY 注释](#232-编写-safety-注释)
      - [2.3.3 Unsafe 代码审查清单](#233-unsafe-代码审查清单)
    - [2.4 内存安全验证](#24-内存安全验证)
      - [2.4.1 自动化测试](#241-自动化测试)
      - [2.4.2 Sanitizers](#242-sanitizers)
  - [💡 并发安全](#-并发安全)
    - [3.1 数据竞争](#31-数据竞争)
      - [3.1.1 Rust 的编译期防护](#311-rust-的编译期防护)
      - [3.1.2 Atomic 操作](#312-atomic-操作)
      - [3.1.3 检测数据竞争](#313-检测数据竞争)
    - [3.2 死锁](#32-死锁)
      - [3.2.1 死锁示例](#321-死锁示例)
      - [3.2.2 死锁防护策略](#322-死锁防护策略)
    - [3.3 Send/Sync 正确性](#33-sendsync-正确性)
      - [3.3.1 Send 和 Sync 的含义](#331-send-和-sync-的含义)
      - [3.3.2 不安全的 Send/Sync 实现](#332-不安全的-sendsync-实现)
      - [3.3.3 裸指针的 Send/Sync](#333-裸指针的-sendsync)
    - [3.4 并发安全验证](#34-并发安全验证)
      - [3.4.1 Loom 深度测试](#341-loom-深度测试)
  - [🔧 密码学最佳实践](#-密码学最佳实践)
    - [4.1 安全随机数](#41-安全随机数)
      - [4.1.1 正确使用 `rand`](#411-正确使用-rand)
      - [4.1.2 密码学安全的随机数](#412-密码学安全的随机数)
    - [4.2 密钥管理](#42-密钥管理)
      - [4.2.1 密钥派生](#421-密钥派生)
      - [4.2.2 密钥存储](#422-密钥存储)
      - [4.2.3 密钥擦除](#423-密钥擦除)
    - [4.3 常见加密场景](#43-常见加密场景)
      - [4.3.1 对称加密 (AES-GCM)](#431-对称加密-aes-gcm)
      - [4.3.2 非对称加密 (RSA)](#432-非对称加密-rsa)
      - [4.3.3 数字签名 (Ed25519)](#433-数字签名-ed25519)
    - [4.4 密码学陷阱](#44-密码学陷阱)
      - [4.4.1 时序攻击](#441-时序攻击)
      - [4.4.2 Nonce 重用](#442-nonce-重用)
  - [📊 安全审计](#-安全审计)
    - [5.1 cargo-audit](#51-cargo-audit)
      - [5.1.1 安装和使用](#511-安装和使用)
      - [5.1.2 CI 集成](#512-ci-集成)
    - [5.2 cargo-deny](#52-cargo-deny)
      - [5.2.1 配置文件](#521-配置文件)
      - [5.2.2 运行检查](#522-运行检查)
    - [5.3 漏洞缓解](#53-漏洞缓解)
      - [5.3.1 依赖固定](#531-依赖固定)
      - [5.3.2 供应链验证](#532-供应链验证)
    - [5.4 供应链安全](#54-供应链安全)
      - [5.4.1 Vendor 本地化](#541-vendor-本地化)
      - [5.4.2 审计第三方依赖](#542-审计第三方依赖)
  - [🚀 实战案例分析](#-实战案例分析)
