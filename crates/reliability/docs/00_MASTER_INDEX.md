...
- [C13 可靠性框架: 主索引 (Master Index)](#c13-可靠性框架-主索引-master-index)
  - [📋 目录](#-目录)
  - [🚀 快速导航](#-快速导航)
    - [1.1 按角色导航](#11-按角色导航)
  - [📝 文档结构](#-文档结构)
    - [2.1 用户指南 (guides/)](#21-用户指南-guides)
    - [2.2 架构设计 (architecture/)](#22-架构设计-architecture)
    - [2.3 API 文档 (api/)](#23-api-文档-api)
    - [2.4 功能文档 (features/)](#24-功能文档-features)
    - [2.5 高级主题 (advanced/)](#25-高级主题-advanced)
    - [2.6 参考资料 (reference/)](#26-参考资料-reference)
    - [2.7 历史归档 (archives/)](#27-历史归档-archives)
  - [🔍 核心功能](#-核心功能)
    - [3.1 容错与弹性](#31-容错与弹性)
    - [3.2 分布式系统](#32-分布式系统)
    - [3.3 并发与并行](#33-并发与并行)
    - [3.4 微服务与云原生](#34-微服务与云原生)
  - [🔧 高级主题](#-高级主题)
    - [4.1 可观测性](#41-可观测性)
    - [4.2 形式化验证](#42-形式化验证)
    - [4.3 运行时环境适配](#43-运行时环境适配)
  - [📊 学习路径](#-学习路径)
    - [5.1 初学者（1周）](#51-初学者1周)
    - [5.2 中级（2-3周)](#52-中级2-3周)
    - [5.3 高级（4周+）](#53-高级4周)
  - [🌟 应用场景](#-应用场景)
    - [6.1 高可用系统](#61-高可用系统)
    - [6.2 分布式系统](#62-分布式系统)
  ...
  - [🔬 外部资源](#-外部资源)
    ...
    - [7.2 相关项目](#72-相关项目)
  - [🔬 最近更新](#-最近更新)
    - [7.1 2025-10-27](#71-2025-10-27)
    - [8.2 2025-10-19](#82-2025-10-19)
    - [8.3 2025-10-12](#83-2025-10-12)
    - [8.4 2025-10-04](#84-2025-10-04)
    - [8.5 2025-10-03](#85-2025-10-03)
  - [📚 获取帮助](#-获取帮助)
    - [9.1 文档资源](#91-文档资源)
    - [9.2 社区支持](#92-社区支持)
