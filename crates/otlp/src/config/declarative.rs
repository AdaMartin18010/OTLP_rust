...
"#;
        ...
        let config = OpenTelemetryConfig::from_yaml(yaml).expect("Failed to parse YAML config");
    ...
    fn test_roundtrip_yaml() {
            ...
            resource: Some(ResourceConfig {
                attributes: {
                    ...
                    m.insert(
                        ...
                        AttributeValueConfig::String("test".to_string()),
                    );
                    m
                },
            }),
        ...
        assert_eq!(
            config.resource.unwrap().attributes,
            parsed.resource.unwrap().attributes
        );
    }
}
