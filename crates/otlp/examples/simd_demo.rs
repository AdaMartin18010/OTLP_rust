...
fn main() {
    ...
    println!("     - Optimal vector size: {} bytes", features.optimal_vector_size());
    ...
    println!("     - starts_with 'Hello': {}", StringOps::starts_with(str1, "Hello"));
    println!("     - ends_with 'Telemetry!': {}", StringOps::ends_with(str1, "Telemetry!"));
    println!("     - contains 'Open': {}", StringOps::contains(str1, "Open"));
    ...
    println!("     - Avg Time/Batch: {:.2} μs", batch_stats.avg_time_per_batch_us());
    println!("     - Throughput: {:.0} values/sec", batch_stats.throughput_values_per_sec());
    println!("\n============================================================\n");
