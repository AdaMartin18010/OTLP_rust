...
- [OTLP Crate 知识图谱](#otlp-crate-知识图谱)
  - [📋 目录](#-目录)
  - [📖 OTLP架构全景](#-otlp架构全景)
    - [1.1 OTLP系统完整架构](#11-otlp系统完整架构)
    - [1.2 数据流转图](#12-数据流转图)
  - [📝 核心组件图谱](#-核心组件图谱)
    - [2.1 OtlpClient架构](#21-otlpclient架构)
    - [2.2 BatchProcessor详细结构](#22-batchprocessor详细结构)
  - [🔍 信号类型体系](#-信号类型体系)
    - [3.1 Traces信号详细结构](#31-traces信号详细结构)
    - [3.2 Metrics信号类型对比](#32-metrics信号类型对比)
  - [🔧 传输协议图谱](#-传输协议图谱)
    - [4.1 gRPC vs HTTP传输对比](#41-grpc-vs-http传输对比)
  - [⚡ 性能优化体系](#-性能优化体系)
    - [5.1 SIMD优化图谱](#51-simd优化图谱)
    - [5.2 Zero-Copy技术栈](#52-zero-copy技术栈)
  - [🌟 可靠性机制](#-可靠性机制)
    - [6.1 重试与容错策略](#61-重试与容错策略)
  - [🔬 概念关系矩阵](#-概念关系矩阵)
    - [7.1 核心组件依赖关系](#71-核心组件依赖关系)
    - [7.2 性能特征矩阵](#72-性能特征矩阵)
  - [🔗 相关资源](#-相关资源)
