...
- [OTLP Rust 故障排查和性能调优指南](#otlp-rust-故障排查和性能调优指南)
  - [📋 目录](#-目录)
  - [故障排查基础](#故障排查基础)
    - [1. 故障排查流程](#1-故障排查流程)
    - [2. 信息收集清单](#2-信息收集清单)
  ...
  - [常见问题诊断](#常见问题诊断)
    - [1. 连接问题](#1-连接问题)
      - [问题：无法连接到OTLP收集器](#问题无法连接到otlp收集器)
      - [解决方案](#解决方案)
    - [2. 性能问题](#2-性能问题)
      - [问题：高延迟](#问题高延迟)
      - [问题：内存泄漏](#问题内存泄漏)
  ...
  - [最佳实践](#最佳实践)
    - [1. 监控最佳实践](#1-监控最佳实践)
    - [2. 故障处理最佳实践](#2-故障处理最佳实践)
    - [3. 性能优化最佳实践](#3-性能优化最佳实践)
    - [4. 安全最佳实践](#4-安全最佳实践)
  - [总结](#总结)
  - [源码映射与可运行命令](#源码映射与可运行命令)
    - [源码映射（排障与性能相关）](#源码映射排障与性能相关)
    - [示例与基准（可直接运行）](#示例与基准可直接运行)
