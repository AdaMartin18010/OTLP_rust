...
- [快速开始指南](#快速开始指南)
  ...
  - [💡 5分钟快速上手](#-5分钟快速上手)
    ...
    - [3.2 基础使用](#32-基础使用)
    - [3.3 运行示例](#33-运行示例)
      - [3.3.1 启动 OTLP Collector (可选)](#331-启动-otlp-collector-可选)
      - [3.3.2 运行您的应用](#332-运行您的应用)
      - [3.3.3 预期输出](#333-预期输出)
  - [🔧 下一步](#-下一步)
    - [4.1 深入学习](#41-深入学习)
    - [4.2 学习路径建议](#42-学习路径建议)
      - [路径 1: 快速实践 (1 周)](#路径-1-快速实践-1-周)
      - [路径 2: 系统学习 (2-3 周)](#路径-2-系统学习-2-3-周)
      - [路径 3: 闭环学习 (推荐)](#路径-3-闭环学习-推荐)
  - [📊 常见问题](#-常见问题)
    - [Q1: 为什么连接不上 OTLP Collector？](#q1-为什么连接不上-otlp-collector)
    - [Q2: 如何查看发送的数据？](#q2-如何查看发送的数据)
    - [Q3: Rust 1.92 有什么特殊配置吗？](#q3-rust-192-有什么特殊配置吗)
