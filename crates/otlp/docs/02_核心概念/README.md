...
- [核心概念](#核心概念)
  ...
  - [3. 核心概念概览](#3-核心概念概览)
    ...
    - [3.2 数据模型](#32-数据模型)
      - [3.2.1 追踪数据（Traces）](#321-追踪数据traces)
      - [3.2.2 指标数据（Metrics）](#322-指标数据metrics)
      - [3.2.3 日志数据（Logs）](#323-日志数据logs)
    - [3.3 传输机制](#33-传输机制)
      - [3.3.1 支持的传输协议](#331-支持的传输协议)
      - [3.3.2 序列化](#332-序列化)
      - [3.3.3 压缩](#333-压缩)
    - [3.4 语义约定](#34-语义约定)
      - [3.4.1 标准化属性](#341-标准化属性)
      - [3.4.2 资源模型](#342-资源模型)
      - [3.4.3 上下文传播](#343-上下文传播)
      - [3.4.4 采样策略](#344-采样策略)
  - [4. 技术架构](#4-技术架构)
    - [4.1 分层架构](#41-分层架构)
    - [4.2 核心组件](#42-核心组件)
