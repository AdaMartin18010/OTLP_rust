...
- [核心 API 使用指南](#核心-api-使用指南)
  - [EnhancedOtlpClient - 基于 opentelemetry-otlp 0.31.0](#enhancedotlpclient---基于-opentelemetry-otlp-0310)
  - [📋 目录](#-目录)
  - [快速开始](#快速开始)
    - [基本用法](#基本用法)
    - [添加依赖](#添加依赖)
  - [API 参考](#api-参考)
    - [EnhancedOtlpClient](#enhancedotlpclient)
      - [创建客户端](#创建客户端)
        - [`builder() -> ClientBuilder`](#builder---clientbuilder)
      - [获取 Tracer](#获取-tracer)
        - [`tracer(&self, name: impl Into<String>) -> impl Tracer`](#tracerself-name-impl-intostring---impl-tracer)
      - [获取统计信息](#获取统计信息)
        - [`stats(&self) -> Future<Output = ClientStats>`](#statsself---futureoutput--clientstats)
      - [获取配置](#获取配置)
        - [`config(&self) -> &ClientConfig`](#configself---clientconfig)
      - [关闭客户端](#关闭客户端)
        - [`shutdown(&self) -> Future<Output = Result<()>>`](#shutdownself---futureoutput--result)
    - [ClientBuilder](#clientbuilder)
      - [配置方法](#配置方法)
        - [`with_endpoint(url: impl Into<String>) -> Self`](#with_endpointurl-impl-intostring---self)
        - [`with_service_name(name: impl Into<String>) -> Self`](#with_service_namename-impl-intostring---self)
        - [`with_timeout(duration: Duration) -> Self`](#with_timeoutduration-duration---self)
        - [`with_protocol(protocol: Protocol) -> Self`](#with_protocolprotocol-protocol---self)
        - [`with_performance_optimization(enable: bool) -> Self`](#with_performance_optimizationenable-bool---self)
        - [`with_reliability_enhancement(enable: bool) -> Self`](#with_reliability_enhancementenable-bool---self)
        - [`with_global_provider(enable: bool) -> Self`](#with_global_providerenable-bool---self)
        - [`build() -> Future<Output = Result<EnhancedOtlpClient>>`](#build---futureoutput--resultenhancedotlpclient)
  - [配置选项](#配置选项)
    - [完整配置示例](#完整配置示例)
    - [配置建议](#配置建议)
      - [开发环境](#开发环境)
      - [生产环境](#生产环境)
  - [使用示例](#使用示例)
    - [示例 1: 基本 Span 创建](#示例-1-基本-span-创建)
    - [示例 2: 嵌套 Spans](#示例-2-嵌套-spans)
    - [示例 3: 并发使用](#示例-3-并发使用)
    - [示例 4: 添加属性和事件](#示例-4-添加属性和事件)
    - [示例 5: 错误处理](#示例-5-错误处理)
  - [最佳实践](#最佳实践)
    - [1. 客户端生命周期](#1-客户端生命周期)
    - [2. Tracer 命名](#2-tracer-命名)
    - [3. Span 生命周期](#3-span-生命周期)
    - [4. 错误处理](#4-错误处理)
    - [5. 并发安全](#5-并发安全)
  - [故障排查](#故障排查)
    - [问题 1: 连接失败](#问题-1-连接失败)
    - [问题 2: Spans 未导出](#问题-2-spans-未导出)
    - [问题 3: 性能问题](#问题-3-性能问题)
  - [📖 相关资源](#-相关资源)
