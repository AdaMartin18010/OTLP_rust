...
- [序列化 (Serialization)](#序列化-serialization)
  ...
  - [📋 概述](#-概述)
  - [🔧 核心工具](#-核心工具)
    - [1. serde (核心框架 ⭐⭐⭐⭐⭐)](#1-serde-核心框架-)
      - [基础用法](#基础用法)
      - [高级特性](#高级特性)
    - [2. serde\_json (JSON ⭐⭐⭐⭐⭐)](#2-serde_json-json-)
    - [3. bincode (二进制 ⭐⭐⭐⭐)](#3-bincode-二进制-)
    - [4. postcard (嵌入式 💡)](#4-postcard-嵌入式-)
    - [5. rmp-serde (MessagePack 💡)](#5-rmp-serde-messagepack-)
    - [6. ciborium (CBOR 💡)](#6-ciborium-cbor-)
  - [💡 最佳实践](#-最佳实践)
    - [1. 版本兼容性](#1-版本兼容性)
    - [2. 枚举序列化](#2-枚举序列化)
    - [3. 扁平化嵌套](#3-扁平化嵌套)
