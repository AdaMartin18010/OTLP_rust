...
- [Rust Essential Crates Library - Master Index](#rust-essential-crates-library---master-index)
  - [📋 目录](#-目录)
  - [🚀 快速导航](#-快速导航)
    - [1.1 库用户](#11-库用户)
    - [1.2 开发者](#12-开发者)
  ...
  - [🔍 目录结构](#-目录结构)
    ...
    - [3.2 essential\_crates/](#32-essential_crates)
    - [3.3 examples/](#33-examples)
    - [3.4 tier层级/](#34-tier层级)
    - [3.5 reports/](#35-reports)
  - [🔧 按用途分类](#-按用途分类)
    - [4.1 入门指南](#41-入门指南)
    - [4.2 选择Crates](#42-选择crates)
  ...
  - [📊 按场景导航](#-按场景导航)
    - [5.1 Web应用开发](#51-web应用开发)
    - [5.2 微服务架构](#52-微服务架构)
    - [5.3 数据处理管道](#53-数据处理管道)
    - [5.4 CLI工具开发](#54-cli工具开发)
    - [5.5 实时系统](#55-实时系统)
    - [5.6 IoT与嵌入式](#56-iot与嵌入式)
  ...
  - [🌟 学习路径](#-学习路径)
    ...
    - [6.2 中级路径（2-4周）](#62-中级路径2-4周)
    - [6.3 高级路径（4周+）](#63-高级路径4周)
  - [🔬 高级主题](#-高级主题)
    - [7.1 形式化验证](#71-形式化验证)
    - [7.2 性能工程](#72-性能工程)
    - [7.3 生产级部署](#73-生产级部署)
    - [7.4 生态系统成熟度](#74-生态系统成熟度)
  - [💻 获取帮助](#-获取帮助)
    - [8.1 常见问题](#81-常见问题)
    - [8.2 术语参考](#82-术语参考)
    - [8.3 联系方式](#83-联系方式)
