...
- [测试完整指南](#测试完整指南)
  ...
  - [✅ 单元测试](#-单元测试)
    ...
    - [3. 错误处理测试](#3-错误处理测试)
  - [🔗 集成测试](#-集成测试)
    - [1. HTTP API 集成测试](#1-http-api-集成测试)
    - [2. 数据库集成测试](#2-数据库集成测试)
    - [3. 端到端测试](#3-端到端测试)
  - [⚡ 性能测试](#-性能测试)
    ...
    - [3. 压力测试](#3-压力测试)
  - [🎭 模拟和桩](#-模拟和桩)
    - [1. 使用 mockall](#1-使用-mockall)
    - [2. HTTP Mock Server](#2-http-mock-server)
  - [属性测试](#属性测试)
    - [1. QuickCheck](#1-quickcheck)
    - [2. Proptest](#2-proptest)
  - [测试覆盖率](#测试覆盖率)
    - [1. 使用 tarpaulin](#1-使用-tarpaulin)
    - [2. 覆盖率目标](#2-覆盖率目标)
    - [3. 覆盖率报告](#3-覆盖率报告)
  - [测试驱动开发](#测试驱动开发)
    - [TDD 周期](#tdd-周期)
